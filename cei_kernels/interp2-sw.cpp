...
//fprintf(stderr,"col=%d\tnum-of-sw=%d\n",col,num_sw);
...
//              fprintf(stderr,"sinc_arg=%f\tsinc_val=%f\twindow=%f\n",sinc_arg,sinc_val,window[window_offset+(k-pmin)]);
            }
...
fprintf(stderr,"interp2@@@ %f seconds elapsed\n", t2-t1);
